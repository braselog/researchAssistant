...
Usage:
    python .github/skills/transcribe/scripts/transcribe.py .research/meetings/audio/recording.m4a
    python .github/skills/transcribe/scripts/transcribe.py .research/meetings/audio/  # Process all untranscribed audio
    python .github/skills/transcribe/scripts/transcribe.py --model large-v3 --language en .research/meetings/audio/recording.m4a

For speaker diarization, set HF_TOKEN environment variable. See .github/skills/transcribe/README.md.
"""
...
PROJECT_ROOT = SCRIPT_DIR.parent.parent.parent.parent  # .github/skills/transcribe/scripts -> project root
